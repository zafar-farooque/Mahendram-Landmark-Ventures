...
function Overview() {
  return (
    <section id="about-overview" className="section-padding" style={{ background: '#0D1B2E' }}>
...
function Divisions() {
  return (
    <section id="about-divisions" className="section-padding" style={{ background: '#050A14' }}>
      <div className="container-xl">
        <div className="text-center mb-12">
          <p className="text-xs font-bold tracking-[0.2em] uppercase mb-2" style={{ color: '#D4891A' }}>Group Structure</p>
          <h2 className="text-3xl md:text-4xl font-extrabold text-white">Our Three Business Divisions</h2>
        </div>
        <div className="grid md:grid-cols-3 gap-6">
          {DIVISIONS.map((d) => (
            <div key={d.name} className="relative flex flex-col gap-5 p-8 rounded-2xl border overflow-hidden hover:-translate-y-1 transition-all duration-300" style={{ background: '#0D1B2E', borderColor: BORDER }}>
...
function CoreValues() {
  return (
    <section id="about-values" className="section-padding" style={{ background: '#0D1B2E' }}>
      <div className="container-xl">
        <div className="text-center mb-12">
          <p className="text-xs font-bold tracking-[0.2em] uppercase mb-2" style={{ color: '#D4891A' }}>What Drives Us</p>
          <h2 className="text-3xl md:text-4xl font-extrabold text-white">Our Core Values</h2>
        </div>
        <div className="flex flex-wrap justify-center gap-4">
          {VALUES.map((v) => (
            <div key={v.label} className="flex items-center gap-3 px-6 py-4 rounded-2xl border hover:-translate-y-0.5 transition-all duration-200" style={{ background: '#050A14', borderColor: BORDER }}>
...
function Timeline() {
  return (
    <section id="about-timeline" className="section-padding" style={{ background: '#050A14' }}>
      <div className="container-xl">
        <div className="text-center mb-12">
          <p className="text-xs font-bold tracking-[0.2em] uppercase mb-2" style={{ color: '#D4891A' }}>Our Journey</p>
          <h2 className="text-3xl md:text-4xl font-extrabold text-white">Milestones Over the Years</h2>
        </div>
  ...
  return (
    <section id="about-cta" className="py-20 relative overflow-hidden" style={{ background: 'linear-gradient(135deg,#0D1B2E 0%,#050A14 100%)' }}>
      ...
      <div className="container-xl relative z-10 flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
        <div>
          <h2 className="text-2xl md:text-3xl font-extrabold text-white">Ready to Partner With Us?</h2>
