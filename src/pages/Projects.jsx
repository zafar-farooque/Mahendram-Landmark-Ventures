...
function PageHero() {
  return (
    <section id="projects-hero" className="relative py-28 md:py-32 overflow-hidden bg-gray-900">
      ...
      <div className="container-xl relative z-10 flex flex-col items-center text-center gap-5">
        ...
        <FadeIn delay={0.3}>
          <p className="text-base md:text-lg max-w-2xl text-white/90 mt-4 drop-shadow-md font-medium leading-relaxed">
