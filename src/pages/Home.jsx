...
function StatsBar() {
  return (
    <section id="stats-bar" className="py-12 relative overflow-hidden"
      style={{ background: '#0D1B2E', borderTop: '1px solid rgba(255,255,255,0.06)', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
      <div className="container-xl w-full grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
        {STATS.map((s, i) => (
      ...
      <div className="container-xl w-full">
        <FadeIn delay={0}>
          <div className="mb-12 text-center">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-white">Three Specialized Divisions</h2>
          </div>
        </FadeIn>
      ...
      <div className="container-xl w-full">
        <FadeIn delay={0}>
          <div className="mb-12 text-center">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-white">Integrated Engineering Solutions</h2>
          </div>
        </FadeIn>
...
function IndustriesStrip() {
  ...
  return (
    <section id="industries-strip" className="py-16 overflow-hidden flex flex-col items-center justify-center relative"
      style={{ background: '#050A14', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
      <FadeIn delay={0}>
      ...
      <div className="container-xl w-full">
        <FadeIn delay={0}>
          <div className="mb-12 text-center">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-white">The Mahendram Landmark Advantage</h2>
          </div>
        </FadeIn>
...
function CTABanner() {
  return (
    <section id="cta-banner" className="py-24 relative overflow-hidden"
      style={{ background: 'linear-gradient(135deg,#0D1B2E 0%,#050A14 100%)' }}>
