      ...
      >
        ...
        <div className="container-xl py-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8 relative z-10">
          ...
          <div className="flex flex-col gap-5">
            ...
            <p className="text-xs font-semibold tracking-wide uppercase leading-relaxed" style={{ color: '#D4891A' }}>
            ...
            <div className="flex flex-col gap-1.5 mt-1">
              {['Mahendram Landmark Ventures', 'Inovvio Interior', 'Ortus Apex'].map((d) => (
                <span
                  ...
                  style={{ background: 'rgba(212,137,26,0.12)', color: '#D4891A', border: '1px solid rgba(212,137,26,0.25)' }}
                >
                  {d}
                </span>
              ))}
          ...
          {/* Col 2: Quick Links */}
          <div>
            <h3 className="text-xs font-bold tracking-[0.15em] uppercase mb-5" style={{ color: '#D4891A' }}>
              Quick Links
            </h3>
            <ul className="flex flex-col gap-2.5">
              {QUICK_LINKS.map((l) => (
                <li key={l.to}>
                  ...
                  >
                    <span className="w-1 h-1 rounded-full flex-shrink-0" style={{ backgroundColor: '#D4891A' }} />
                    {l.label}
                  </Link>
                </li>
              ))}
